  ...
  <div class="bmbox_layout  clearfix">
    <div class="bmbox_title ">
      ...
      <div class="bmbox_tool">
        ...
        <button class="btn btn-primary btn-sm btn-smx" type="button"><i class="fa fa-check"></i> 通过</button>
        <button class="btn btn-danger btn-sm btn-smx" type="button"><i class="fa fa-close"></i> 不通过</button>
      </div>
    </div>
    <div class="bmbox_content clearfix pd10">
      ...
      <div class="bmbox_layout  clearfix">
        <div class="bmbox_title" style="border-top-color: #e0e0e0;">
          ...
          <div class="bmbox_tool">
            <button id="btn_addnewcase" class="btn btn-white btn-sm btn-smx" type="button"><i class="fa fa-plus"></i> 添加案件</button>
          </div>
        </div>
