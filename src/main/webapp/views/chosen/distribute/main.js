$(function () {
    ...
    $("#table1").jqGrid({
        ...
        colModel : [
            ...
            {label : '已填报案件数',name : 'pclx',align : 'center',sortable : false, width : 120,
                formatter : function(cellvalue, options, rowObject) {
            ...
            {label : '截止时间',name : 'fbsj',sortable : false,width : 100},
    ...
    $("#table2").jqGrid({
        ...
        colModel : [
            {label : 'ggid',name : 'ggid',hidden : true,key : true},
            {label : 'btys',name : 'btys', hidden : true},
            {label : '操作',name : 'ggid',width : 120,align : 'center',sortable : false,
                formatter : function(cellvalue, options, rowObject) {
            ...
            {label : '已填报案件数',name : 'pclx',align : 'center',width : 120,sortable : false,
                formatter : function(cellvalue, options, rowObject) {
