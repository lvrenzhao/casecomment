...
public class MD5Utils {
	...
	public String getFileMD5String(File file) throws IOException {
		...
		return getMD5String(fis);
	}

	public String getMD5String(InputStream in) throws IOException {
	...
	public String getMD5String(String content) throws IOException {
		return bufferToHex(messagedigest.digest(content.getBytes("utf-8")));
	}
