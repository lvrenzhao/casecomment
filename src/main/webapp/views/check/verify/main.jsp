      ...
      <div id="tab-2" class="tab-pane">
        <div id="search_box1" class="form_center clearfix">
          ...
          <div class="form_item wb35 fl">
            <label>发布日期</label>
            <div>
              <input type="text" id="form_inp_fbsj1" class="form-control input-sm wb45 fl" placeholder="" maxlength="255" onclick="laydate({istime: true,format: 'YYYY/MM/DD'})" />
              <span style="display: inline-block;float: left;padding: 5px 10px 0px 10px;">~</span>
              <input type="text" id="form_inp_fbsj2" class="form-control input-sm wb45 fl" placeholder="" maxlength="255" onclick="laydate({istime: true,format: 'YYYY/MM/DD'})" />
            </div>
